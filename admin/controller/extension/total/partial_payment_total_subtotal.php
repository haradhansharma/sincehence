...
class ControllerExtensionTotalPartialPaymentTotalSubtotal extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/total/partial_payment_total_subtotal', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/total/partial_payment_total_subtotal', 'user_token=' . $this->session->data['user_token'], true);
