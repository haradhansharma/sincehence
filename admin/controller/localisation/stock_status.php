...
class ControllerLocalisationStockStatus extends Controller {
	...
	protected function getForm() {
		...
		///
		   if (!empty($this->request->get['stock_status_id'])){
		$data['disabledcondition']= $this->request->get['stock_status_id'];
	    }
        $data['stock_status_id'] = array();
        $this->load->model('extension/input_order_days');
		$result=$this->model_extension_input_order_days->inactivestockstatus();


		 foreach ($result as $result) {
			$data['stock_status_id'] = $result['stock_status_id'];
