...
class ControllerLocalisationOrderStatus extends Controller {
	...
	protected function getForm() {
		...
		$data['disabledcondition']= $this->request->get['order_status_id'];
	    }
		...
		$data['order_status_id1'] = array();
		$result=$this->model_extension_input_order_days->inactiveorderstatus1();


		 foreach ($result as $result) {
			$data['order_status_id1'] = $result['order_status_id'];
			
		}
		$data['order_status_id2'] = array();
		$result=$this->model_extension_input_order_days->inactiveorderstatus2();


		 foreach ($result as $result) {
			$data['order_status_id2'] = $result['order_status_id'];
			
		}
		$data['order_status_id3'] = array();
		$result=$this->model_extension_input_order_days->inactiveorderstatus3();


		 foreach ($result as $result) {
			$data['order_status_id3'] = $result['order_status_id'];
			
		}
		$data['order_status_id4'] = array();
		$result=$this->model_extension_input_order_days->inactiveorderstatus4();


		 foreach ($result as $result) {
			$data['order_status_id4'] = $result['order_status_id'];
			
		}

				$data['order_status_id5'] = array();
		$result=$this->model_extension_input_order_days->inactiveorderstatus5();


		 foreach ($result as $result) {
			$data['order_status_id5'] = $result['order_status_id'];
			
		}

				$data['order_status_id6'] = array();
		$result=$this->model_extension_input_order_days->inactiveorderstatus6();


		 foreach ($result as $result) {
			$data['order_status_id6'] = $result['order_status_id'];
			
		}

				$data['order_status_id7'] = array();
		$result=$this->model_extension_input_order_days->inactiveorderstatus7();


		 foreach ($result as $result) {
			$data['order_status_id7'] = $result['order_status_id'];
			
		}

		$data['order_status_id8'] = array();
		$result=$this->model_extension_input_order_days->inactiveorderstatus8();


		 foreach ($result as $result) {
			$data['order_status_id8'] = $result['order_status_id'];
