...
//
		// $data['disabledcondition']= $this->request->get['option_id'];
...
//
	...
	if(!empty($this->request->get['option_id'])){ 
		...
		$result = $this->model_extension_input_order_days->inactiveoption();

		 foreach ($result as $result) {
			$data['option_id'] = $result['option_id'];
			
		}
		$data['option_idd'] = array();
		$resultop = $this->model_extension_input_order_days->inactiveoption2();

		 foreach ($resultop as $resulto) {
			$data['option_idd'] = $resulto['option_id'];
