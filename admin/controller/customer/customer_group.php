...
///
   if (!empty($this->request->get['customer_group_id'])){
		$data['disabledcondition']= $this->request->get['customer_group_id'];
	}
		...
		$data['customer_group_id1'] = array();
		$result=$this->model_extension_input_order_days->inactivecustomergroup1();


		 foreach ($result as $result) {
			$data['customer_group_id1'] = $result['customer_group_id'];
			
		}
		$data['customer_group_id2'] = array();
		$result=$this->model_extension_input_order_days->inactivecustomergroup2();


		 foreach ($result as $result) {
			$data['customer_group_id2'] = $result['customer_group_id'];
