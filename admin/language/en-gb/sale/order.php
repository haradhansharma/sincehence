...
$_['text_delivery_condition']              = 'If there is a problem with the product, please check and return while the supplier is there. Products are not refunded after the supplier leaves.';
$_['text_sales_point']              = '"sincehence" approved sales point, which you select when ordering ';
$_['text_liability']              = ' is responsible for any issues related to this order. Contact him about anything related to this order!';
$_['text_complain']              = 'If you have any complaints regarding sales points ';
$_['text_please_contact']              = ' please contact through prescribed system of the website mentioned in the invoice.';
$_['text_color_of_goods']              = 'There may be slight variation of the actual product with the product displayed on the web. Your cooperation is highly desirable.';
