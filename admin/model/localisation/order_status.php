...
//
	...
	public function deleteOrderStatus($order_status_id) {
        ...
        foreach ($query->rows as $result) {
			$sql8 = $result['order_status_id'];
		}




		if($order_status_id== $sql || $order_status_id== $sql2 || $order_status_id== $sql3 || $order_status_id== $sql4 || $order_status_id== $sql5 || $order_status_id== $sql6 || $order_status_id== $sql7 || $order_status_id== $sql8){
