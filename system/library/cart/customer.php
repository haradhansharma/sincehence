...
class Customer {
	...
	////sharma
	private $customer_group_comission;
	////sharma
	private $email;
	private $telephone;
	private $newsletter;
	...
	public function __construct($registry) {
		...
		if (isset($this->session->data['customer_id'])) {
			...
			if ($customer_query->num_rows) {
				...
				////sharma
				$group_comission =  $this->db->query("SELECT  `comission` FROM `" . DB_PREFIX . "customer_group` WHERE `customer_group_id` = '" . (int)$this->customer_group_id . "'");
				$this->customer_group_comission = $group_comission->row['comission'];
				////sharma
  ...
  public function login($email, $password, $override = false) {
	...
	////sharma
	public function getGroupComission() {
		...
		return $this->customer_group_comission;
	    }
	}
	////sharma
